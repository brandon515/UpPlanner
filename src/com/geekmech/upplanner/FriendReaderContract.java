...
public class FriendReaderContract {
	public FriendReaderContract(){}
	
	public static abstract class EventEntry implements BaseColumns{
		public static final String TABLE_NAME = "Friends";
		public static final String COLUMN_FRIEND_NAME	 = "Name";
		public static final String COLUMN_FRIEND_NUMBER	 = "Number";
	}
	...
	private static final String SQL_CREATE_ENTRIES =
	    ...
	    EventEntry.COLUMN_FRIEND_NAME + TEXT_TYPE + COMMA_SEP +
	    EventEntry.COLUMN_FRIEND_NUMBER + TEXT_TYPE + COMMA_SEP +
	    " )";
